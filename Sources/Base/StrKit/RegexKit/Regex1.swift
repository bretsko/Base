...
//    public init(_ pattern: Str, options: Options = []) throws {
...
//    @inlinable
//    public func matches(_ string: Str) -> Bool {
...
//    @inlinable
//    public func firstMatch(in string: Str) -> Match? {
...
//    @inlinable
//    public func matches(in string: Str) -> [Match] {
...
//    @inlinable
//    public func replacingMatches(in input: Str, with template: Str, count: Int? = nil) -> Str {
//        var output = input
...
//        public lazy var string: Str = {
//            Str(describing: self.baseString[self.range])
//        }()
//
//        /// The range of the matched string.
//        public lazy var range: Range<StrIdx> = {
...
//                return Str(describing: self.baseString[captureRange])
//            }
//        }()
//
//        private let result: NSTextCheckingResult
//
//        private let baseString: Str
//
//        // MARK: - Initializers
//        @usableFromInline
//        internal init(result: NSTextCheckingResult, in string: Str) {
//            precondition(
...
//        public func string(applyingTemplate template: Str) -> Str {
